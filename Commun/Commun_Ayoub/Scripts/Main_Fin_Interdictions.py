...
Image_Information_Dataframe_Test = Image_Information_Dataframe_Test[Image_Information_Dataframe_Test["Type"]== "Fin_Interdictions"]
Image_Information_Dataframe_Train = Image_Information_Dataframe_Train[Image_Information_Dataframe_Train["Type"]== "Fin_Interdictions"]
Image_Information_Dataframe = Image_Information_Dataframe[Image_Information_Dataframe["Type"]== "Fin_Interdictions"]
...
images_train, types_train, sublabels_train, labels_train = import_images_tensor(Image_Information_Dataframe_Train.sample(frac=Frac_Images_To_Import),"Path", "Type", "Sublabel", "Label",resize=resize, size=size,normalize=normalize)
images_test , types_test, sublabels_test, labels_test = import_images_tensor(Image_Information_Dataframe_Test.sample(frac=Frac_Images_To_Import),"Path", "Type", "Sublabel", "Label",resize=resize, size=size,normalize=normalize)



# Création des dictionnaires d'encodage
save_dicts = True
Path_Save_Dicts = "/home/ayoubchoukri/Etudes/5A/Stats_Grande_Dimension/Projets/Projet/Projet_HDDL_2/Commun/Commun_Ayoub/Encoding_Dictionaries/Fin_Interdictions/"
...
Model_Path = "/home/ayoubchoukri/Etudes/5A/Stats_Grande_Dimension/Projets/Projet/Projet_HDDL_2/Commun/Commun_Ayoub/Saved_Models/Model_Fin_Interdictions.pth"
...
augment = True
transform_type =create_transofrm_augmentation_labels(p=0.3)

Confusion_Matrix_Saving_Path = "/home/ayoubchoukri/Etudes/5A/Stats_Grande_Dimension/Projets/Projet/Projet_HDDL_2/Commun/Commun_Ayoub/Metrics/Metrics_Fin_Interdictions/Confusion_Matrix/"
Losses_Saving_Path = "/home/ayoubchoukri/Etudes/5A/Stats_Grande_Dimension/Projets/Projet/Projet_HDDL_2/Commun/Commun_Ayoub/Metrics/Metrics_Fin_Interdictions/Losses/"
if Train:
