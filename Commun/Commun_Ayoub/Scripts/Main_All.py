...
# Image_Information_Dataframe_Test = Image_Information_Dataframe_Test[Image_Information_Dataframe_Test["Type"]== "Dangers"]
# Image_Information_Dataframe_Train = Image_Information_Dataframe_Train[Image_Information_Dataframe_Train["Type"]== "Dangers"]
# Image_Information_Dataframe = Image_Information_Dataframe[Image_Information_Dataframe["Type"]== "Dangers"]
...
save_dicts = True
Path_Save_Dicts = "/home/ayoubchoukri/Etudes/5A/Stats_Grande_Dimension/Projets/Projet/Projet_HDDL_2/Commun/Commun_Ayoub/Encoding_Dictionaries/All/"
...
Model_Path = "/home/ayoubchoukri/Etudes/5A/Stats_Grande_Dimension/Projets/Projet/Projet_HDDL_2/Commun/Commun_Ayoub/Saved_Models/Model_All.pth"
...
plot_confusion_matrix(confusion_Matrix_Train,int_to_labels,figsize=(30,25),adjust_for_labels=True,savefig=True,path= Confusion_Matrix_Saving_Path+"Confusion_Matrix_Train.png")
plot_confusion_matrix(confusion_Matrix_Test,int_to_labels,figsize=(30,25),adjust_for_labels=True,savefig=True,path= Confusion_Matrix_Saving_Path+"Confusion_Matrix_Test.png")
## Normalized
