...
os.chdir("/home/duy_ordi/Documents/5 ModIA/Semester 1/Projet Panneau/Projet_HDDL_2/Commun/Commun_Duy")
...
Path_Modules = "/home/duy_ordi/Documents/5 ModIA/Semester 1/Projet Panneau/Projet_HDDL_2/Commun/Modules"
Path_Models = "/home/duy_ordi/Documents/5 ModIA/Semester 1/Projet Panneau/Projet_HDDL_2/Commun/Commun_Duy/Models"
...
save_dicts = True
Path_Save_Dicts = "./Encoding_Dictionaries/Types/"
...
BATCH_SIZE = 18
dataloader_train, _ = create_dataloader(images_train, types_encoded_train, sublabels_encoded_train, labels_encoded_train, batch_size=BATCH_SIZE, test_size=0, shuffle=True)

dataloader_test ,_= create_dataloader(images_test, types_encoded_test, sublabels_encoded_test, labels_encoded_test, batch_size=BATCH_SIZE, test_size=0, shuffle=True)
...
Model_Path = "./Saved_Models/Model_All.pth"

Model = load_vit_b_16(num_classes=np.unique(labels_train).shape[0])
...
Confusion_Matrix_Saving_Path = "./Metrics/Metrics_All/Confusion_Matrix/"
Losses_Saving_Path = "./Metrics/Metrics_All/Losses/"
if Train:
...
plot_confusion_matrix(confusion_Matrix_Train,int_to_label=int_to_labels,figsize=(60,50),savefig=True,path= Confusion_Matrix_Saving_Path+"Confusion_Matrix_Train.png")
plot_confusion_matrix(confusion_Matrix_Test,int_to_label=int_to_labels,figsize=(60,50),savefig=True,path= Confusion_Matrix_Saving_Path+"Confusion_Matrix_Test.png")
plot_confusion_matrix(confusion_Matrix_Test,normalize=True, int_to_label=int_to_labels, figsize=(60,50),adjust_for_labels=True,savefig=True,path= Confusion_Matrix_Saving_Path+"Confusion_Matrix_Test_Normalized.png")
plot_confusion_matrix(confusion_Matrix_Train,normalize=True, int_to_label=int_to_labels, figsize=(60,50),adjust_for_labels=True,savefig=True,path= Confusion_Matrix_Saving_Path+"Confusion_Matrix_Train_Normalized.png")