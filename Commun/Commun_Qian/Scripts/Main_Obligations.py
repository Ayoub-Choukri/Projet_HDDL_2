...
save_dicts = True
Path_Save_Dicts = "./Encoding_Dictionaries/Obligations/"

types_to_int , int_to_types = Create_Encoding_Label_Dictionary(types_train)
sublabels_to_int , int_to_sublabels = Create_Encoding_Label_Dictionary(sublabels_train,save=save_dicts,path=Path_Save_Dicts)
labels_to_int , int_to_labels = Create_Encoding_Label_Dictionary(labels_train,save=save_dicts,path=Path_Save_Dicts)
...
Model = get_MobileNet(len(labels_to_int), pretrained=False)
...
augment = True
transform_type =create_transofrm_augmentation_labels(p=0.6,rotmax=10,prob_vertical_flip = 0.)
